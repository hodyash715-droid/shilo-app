...
export const ICONS = {
  ...
  team: (p) => <svg {...s} {...p}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>,
  field: (p) => <svg {...s} {...p}><path d="M1 3h15v13H1z" /><path d="M16 8h4l3 3v5h-7z" /><circle cx="5.5" cy="18.5" r="2.5" /><circle cx="18.5" cy="18.5" r="2.5" /></svg>,
...
export const TABS = [
  ...
  { id: 'calendar', label: 'יומן', icon: ICONS.calendar },
  { id: 'team', label: 'צוות', icon: ICONS.team },
  { id: 'field', label: 'בשטח', icon: ICONS.field },
